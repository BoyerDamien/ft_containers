...
void test_merge(void (*check)(test_type &, ref_type &)) {
  int init[] = {1, 2, 3};
  int init2[] = {4, 5, 6};
...
template <typename test_type, typename ref_type>
void test_splice(void (*check)(test_type &, ref_type &)) {
  int init[] = {1, 2, 3};
  int init2[] = {4, 5, 6};
...
template <typename test_type, typename ref_type>
void test_remove(void (*check)(test_type &, ref_type &)) {
...
bool is_four(const number &n) {
  return n == 4;
}

template <typename test_type, typename ref_type>
void test_remove_if(void (*check)(test_type &, ref_type &)) {
  int init[] = {-1, 1, 2, 3, 4, 4, 4, 4, 5, 1, 2, 6, 7, 8, 8, 10};
...
template <typename test_type, typename ref_type>
void test_unique(void (*check)(test_type &, ref_type &)) {
  int init[] = {-1, 1, 2, 3, 4, 4, 4, 4, 5, 1, 2, 6, 7, 8, 8, 10};
...
template <typename test_type, typename ref_type>
void test_sort(void (*check)(test_type &, ref_type &)) {
...
template <typename test_type, typename ref_type>
void test_reverse(void (*check)(test_type &, ref_type &)) {
  int init[] = {1, 2, 3, 4, 5};
