...
void test_operator_access(void (*check)(test_type &, ref_type &)) {
  int init[] = {1, 2, 3, 4, 5};
...
template <typename test_type, typename ref_type>
void test_front(void (*check)(test_type &, ref_type &)) {
  int init[] = {1, 2, 3, 4, 5};
...
template <typename test_type, typename ref_type>
void test_back(void (*check)(test_type &, ref_type &)) {
  int init[] = {1, 2, 3, 4, 5};
...
template <typename test_type, typename ref_type>
void test_at(void (*check)(test_type &, ref_type &)) {
  int init[] = {1, 2, 3, 4, 5};
