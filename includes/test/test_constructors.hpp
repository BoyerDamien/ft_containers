...
void test_default_constructor( void ( *check )( test_type &,
...
template < typename test_type, typename ref_type >
void test_constructor_size( void ( *check )( test_type &,
                                             ref_type & ) ) throw( std::exception )
{
    test_type test( 3, 3 );
...
template < typename test_type, typename ref_type >
void test_constructor_iter( void ( *check )( test_type &,
                                             ref_type & ) ) throw( std::exception )
{
...
template < typename test_type, typename ref_type >
void test_copy_constructor( void ( *check )( test_type &,
                                             ref_type & ) ) throw( std::exception )
{
    test_type test( 3, 3 );
    ref_type test_ref( 3, 3 );
...
template < typename test_type, typename ref_type >
void test_assignation_constructor( void ( *check )( test_type &,
                                                    ref_type & ) ) throw( std::exception )
{
    test_type test( 3, 3 );
    ref_type test_ref( 3, 3 );
