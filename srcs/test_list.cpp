...
/*   Updated: 2021/09/10 16:00:04 by dboyer           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool unittest::test_list(void) {
  const ::Test tests[] = {
      ...
      ::Test("test list size()", unittest::test_size<test_type, ref_type>,
             unittest::default_check),
      ::Test("test list max_size()",
             unittest::test_max_size<test_type, ref_type>,
             unittest::default_check),
      ...
      ::Test("test list push_front()",
             ...
             unittest::default_check),
      ::Test("test list pop_front()",
             unittest::test_pop_front<test_type, ref_type>,
             unittest::default_check),
      ::Test("test list push_back()",
             unittest::test_push_back<test_type, ref_type>,
             unittest::default_check),
      ::Test("test list pop_back()",
             unittest::test_pop_back<test_type, ref_type>,
             unittest::default_check),
      ...
      ::Test("test list remove()", unittest::test_remove<test_type, ref_type>,
             unittest::default_check),
      ::Test("test list remove_if()",
             unittest::test_remove_if<test_type, ref_type>,
             unittest::default_check),
